...
def test():
    assert round(get_price_of('part7/datos.txt', {'kiwi':5, 'naranja':2}), 2 ) == 16.65, "the kiwi and naranja should be 16.65 €"
    assert round(get_price_of('part7/datos.txt', {'platano':10}), 2 ) == 13.9, "the platano should be 13.9 €"
    assert round(get_price_of('part7/datos.txt', {}), 2 ) == 0, "0 € if no products"
